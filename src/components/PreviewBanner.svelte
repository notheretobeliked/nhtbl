...
{#if isPreview}
	<div class="fixed top-0 left-0 right-0 z-50 bg-caution text-extremedanger border-b-2 border-extremedanger shadow-lg">
...
<style>
	/* Ensure the banner stays on top of everything */
	.z-50 {
		z-index: 9999;
	}
</style> 
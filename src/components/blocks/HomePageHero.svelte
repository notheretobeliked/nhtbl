...
<div class="h-[3000px] relative">
  ...
  <div class="fixed bottom-10 font-serif text-base text-center w-full flex flex-row justify-center">
    {#if percentage > 90}
      <svg width="89" height="110" viewBox="0 0 89 110" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" preserveAspectRatio="all">
        <path
          class="fill-black"
    ...
    {:else if percentage > 1 && !stopped}
      <span class="text-white">
        <svg width="89" height="110" class="w-12 h-12" preserveAspectRatio="all" viewBox="0 0 89 110" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path

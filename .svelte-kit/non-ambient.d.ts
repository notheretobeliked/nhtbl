...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/octopus-walkthrough" | "/plas" | "/plas/event" | "/plas/script.js" | "/portfolio" | "/portfolio/[slug]" | "/preview" | "/[...all]";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/plas": Record<string, never>;
			"/plas/event": Record<string, never>;
			"/plas/script.js": Record<string, never>;
			"/portfolio": { slug?: string };
			"/portfolio/[slug]": { slug: string };
			"/preview": Record<string, never>;
			"/[...all]": { all: string }
		};
		Pathname(): "/" | "/octopus-walkthrough" | "/octopus-walkthrough/" | "/plas" | "/plas/" | "/plas/event" | "/plas/event/" | "/plas/script.js" | "/plas/script.js/" | "/portfolio" | "/portfolio/" | `/portfolio/${string}` & {} | `/portfolio/${string}/` & {} | "/preview" | "/preview/" | `/${string}` & {} | `/${string}/` & {};

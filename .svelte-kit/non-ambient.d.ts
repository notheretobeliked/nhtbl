...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/octopus-walkthrough" | "/plas" | "/plas/event" | "/plas/script.js" | "/portfolio" | "/portfolio/[slug]" | "/[...all]";
		RouteParams(): {
		...
		Pathname(): "/" | "/octopus-walkthrough" | "/octopus-walkthrough/" | "/plas" | "/plas/" | "/plas/event" | "/plas/event/" | "/plas/script.js" | "/plas/script.js/" | "/portfolio" | "/portfolio/" | `/portfolio/${string}` & {} | `/portfolio/${string}/` & {} | `/${string}` & {} | `/${string}/` & {};
